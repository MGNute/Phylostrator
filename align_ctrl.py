...
class WxfbAlignmentControlPanel ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		self.m_staticText1.SetFont( wx.Font( 11, wx.FONTFAMILY_SWISS, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD, True, "Arial" ) )
		...
		self.m_AlnFile = wx.FilePickerCtrl( self.m_panel1, wx.ID_ANY, u"C:\\Users\\miken\\Dropbox\\GradSchool\\Phylogenetics\\work\\ehsan-msa\\data_for_dryad\\BAliBase\\BPPD\\BALBS374.faa", u"Select a file", u"*.*", wx.DefaultPosition, wx.DefaultSize, wx.FLP_DEFAULT_STYLE )
		...
		self.m_TreeFile = wx.FilePickerCtrl( self.m_panel1, wx.ID_ANY, u"C:\\Users\\miken\\Dropbox\\GradSchool\\Phylogenetics\\work\\ehsan-msa\\trees_on_bio_data\\BAliBase\\BALBS374\\RAxML_result.tree", u"Select a file", u"*.*", wx.DefaultPosition, wx.DefaultSize, wx.FLP_DEFAULT_STYLE )
		...
		m_dataTypeChoices = [ u"DNA", u"RNA", u"Protein" ]
		self.m_dataType = wx.ComboBox( self.m_panel1, wx.ID_ANY, u"RNA", wx.DefaultPosition, wx.DefaultSize, m_dataTypeChoices, 0 )
		self.m_dataType.SetSelection( 1 )
		bSizer31.Add( self.m_dataType, 1, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 1 )
		...
		self.m_textAlnNumTaxa = wx.TextCtrl( self.m_panel1, wx.ID_ANY, u"(numtaxa)", wx.DefaultPosition, wx.DefaultSize, wx.TE_READONLY|wx.BORDER_NONE )
		...
		self.m_textAlnLength = wx.TextCtrl( self.m_panel1, wx.ID_ANY, u"(numtaxa)", wx.DefaultPosition, wx.DefaultSize, wx.TE_READONLY|wx.BORDER_NONE )
		...
		self.m_AnnotationFile = wx.FilePickerCtrl( self.m_panel1, wx.ID_ANY, u"C:\\Users\\miken\\GradSchoolStuff\\Research\\Phylogenetics\\results\\2017-03-ehsan-bp-mafft\\bppd_visuals\\annotations\\BALBS374.txt", u"Select a file", u"*.*", wx.DefaultPosition, wx.DefaultSize, wx.FLP_DEFAULT_STYLE )
		...
		self.m_staticText7.SetFont( wx.Font( 11, wx.FONTFAMILY_SWISS, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD, True, "Arial" ) )
		...
		self.m_textCairoImgWidth = wx.TextCtrl( self. m_panel2, wx.ID_ANY, u"1025", wx.DefaultPosition, wx.Size( 50,-1 ), 0 )
		...
		self.m_textCairoImgHeight = wx.TextCtrl( self. m_panel2, wx.ID_ANY, u"725", wx.DefaultPosition, wx.Size( 50,-1 ), 0 )
		...
		self.m_textCairoImgFolder = wx.DirPickerCtrl( self. m_panel2, wx.ID_ANY, u"C:\\Users\\miken\\GradSchoolStuff\\Research\\Phylogenetics\\results\\2017-03-ehsan-bp-mafft\\bppd_visuals", u"Select a folder", wx.DefaultPosition, wx.DefaultSize, wx.DIRP_DEFAULT_STYLE )
		...
		self.m_textPctWidthToPhylogeny = wx.TextCtrl( self. m_panel2, wx.ID_ANY, u"5", wx.DefaultPosition, wx.Size( 50,-1 ), 0 )
		bSizer24.Add( self.m_textPctWidthToPhylogeny, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5 )
		
		
		bSizer24.Add( ( 0, 0), 1, wx.EXPAND, 5 )
		
		self.m_btnAdvance = wx.Button( self. m_panel2, wx.ID_ANY, u"    next >>", wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer24.Add( self.m_btnAdvance, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5 )
		...
		self.m_textPctWidthToAlignment = wx.TextCtrl( self. m_panel2, wx.ID_ANY, u"90", wx.DefaultPosition, wx.Size( 50,-1 ), 0 )
		bSizer241.Add( self.m_textPctWidthToAlignment, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5 )
		
		
		bSizer241.Add( ( 0, 0), 1, wx.EXPAND, 5 )
		
		self.m_btnGoBack = wx.Button( self. m_panel2, wx.ID_ANY, u"<< prev    ", wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer241.Add( self.m_btnGoBack, 0, wx.ALL, 5 )
		
		
		bSizer241.Add( ( 0, 0), 1, wx.EXPAND, 5 )
		
		
		bSizer14.Add( bSizer241, 0, wx.EXPAND, 5 )
		...
		self.m_btnAdvance.Bind( wx.EVT_BUTTON, self.advance_image )
		self.m_btnGoBack.Bind( wx.EVT_BUTTON, self.roll_back_image )
	...
	def advance_image( self, event ):
		event.Skip()
	
	def roll_back_image( self, event ):
		event.Skip()
