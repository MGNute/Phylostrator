...
class WxfbAlignmentControlPanel ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		self.m_AlnFile = wx.FilePickerCtrl( self.m_panel1, wx.ID_ANY, u"D:\\Users\\miken.DESKTOP-4FP24QU\\Dropbox\\Grad School\\Phylogenetics\\work\\new-rdp-tipp\\erin-alignments\\sate.fas", u"Select a file", u"*.*", wx.DefaultPosition, wx.DefaultSize, wx.FLP_DEFAULT_STYLE )
		...
		self.m_TreeFile = wx.FilePickerCtrl( self.m_panel1, wx.ID_ANY, u"D:\\Users\\miken.DESKTOP-4FP24QU\\Dropbox\\Grad School\\Phylogenetics\\work\\new-rdp-tipp\\erin-alignments\\sate.tre", u"Select a file", u"*.*", wx.DefaultPosition, wx.DefaultSize, wx.FLP_DEFAULT_STYLE )
		...
		self.m_textAlnNumTaxa = wx.TextCtrl( self.m_panel1, wx.ID_ANY, u"(numtaxa)", wx.DefaultPosition, wx.Size( 100,-1 ), wx.TE_READONLY|wx.NO_BORDER )
		...
		self.m_textAlnNumTaxa.SetMinSize( wx.Size( 100,-1 ) )
		
		bSizer5.Add( self.m_textAlnNumTaxa, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5 )
		
		self.m_checkBox1 = wx.CheckBox( self.m_panel1, wx.ID_ANY, u"Mask Gappy Columns:", wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer5.Add( self.m_checkBox1, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5 )
		
		self.m_textCtrl20 = wx.TextCtrl( self.m_panel1, wx.ID_ANY, u".1", wx.DefaultPosition, wx.Size( 30,-1 ), wx.TE_PROCESS_ENTER|wx.TE_RIGHT )
		self.m_textCtrl20.Enable( False )
		self.m_textCtrl20.SetMinSize( wx.Size( 30,-1 ) )
		
		bSizer5.Add( self.m_textCtrl20, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 0 )
		
		self.m_staticText381 = wx.StaticText( self.m_panel1, wx.ID_ANY, u"%", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText381.Wrap( -1 )
		bSizer5.Add( self.m_staticText381, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5 )
		...
		self.m_staticText23.SetMinSize( wx.Size( 50,-1 ) )
		
		bSizer53.Add( self.m_staticText23, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5 )
		
		self.m_textAlnLength = wx.TextCtrl( self.m_panel1, wx.ID_ANY, u"(numcols)", wx.DefaultPosition, wx.Size( 100,-1 ), wx.TE_READONLY|wx.NO_BORDER )
		...
		self.m_textAlnLength.SetMinSize( wx.Size( 100,-1 ) )
		
		bSizer53.Add( self.m_textAlnLength, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5 )
		
		self.m_staticText231 = wx.StaticText( self.m_panel1, wx.ID_ANY, u"Length (masked):", wx.DefaultPosition, wx.Size( 100,-1 ), 0 )
		self.m_staticText231.Wrap( -1 )
		self.m_staticText231.Enable( False )
		self.m_staticText231.SetMinSize( wx.Size( 100,-1 ) )
		
		bSizer53.Add( self.m_staticText231, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5 )
		
		self.m_textAlnLength1 = wx.TextCtrl( self.m_panel1, wx.ID_ANY, u"(numcols)", wx.DefaultPosition, wx.Size( 100,-1 ), wx.TE_READONLY|wx.NO_BORDER )
		self.m_textAlnLength1.SetForegroundColour( wx.SystemSettings.GetColour( wx.SYS_COLOUR_CAPTIONTEXT ) )
		self.m_textAlnLength1.SetBackgroundColour( wx.SystemSettings.GetColour( wx.SYS_COLOUR_WINDOW ) )
		self.m_textAlnLength1.Enable( False )
		self.m_textAlnLength1.SetMinSize( wx.Size( 100,-1 ) )
		
		bSizer53.Add( self.m_textAlnLength1, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5 )
		...
		self.m_AnnotationFile = wx.FilePickerCtrl( self.m_panel1, wx.ID_ANY, u"D:\\Users\\miken.DESKTOP-4FP24QU\\Dropbox\\Grad School\\Phylogenetics\\work\\new-rdp-tipp\\erin-alignments\\annotation_seqname_phyl-ord.txt", u"Select a file", u"*.*", wx.DefaultPosition, wx.DefaultSize, wx.FLP_DEFAULT_STYLE )
		...
		self.m_notebook2.AddPage( self.m_panel1, u"Dashboard", False )
		self. m_panel2 = wx.Panel( self.m_notebook2, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.TAB_TRAVERSAL )
		bSizer13 = wx.BoxSizer( wx.HORIZONTAL )
		
		bSizer14 = wx.BoxSizer( wx.VERTICAL )
		
		self.m_staticText7 = wx.StaticText( self. m_panel2, wx.ID_ANY, u"Cairo Settings", wx.DefaultPosition, wx.Size( -1,22 ), 0 )
		self.m_staticText7.Wrap( -1 )
		self.m_staticText7.SetFont( wx.Font( 11, 74, 90, 92, True, "Arial" ) )
		
		bSizer14.Add( self.m_staticText7, 0, wx.ALL, 1 )
		
		self.m_staticText9 = wx.StaticText( self. m_panel2, wx.ID_ANY, u"Image Size:", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.m_staticText8 = wx.StaticText( self. m_panel2, wx.ID_ANY, u"Width", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText8.Wrap( -1 )
		bSizer16.Add( self.m_staticText8, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 1 )
		
		self.m_textCairoImgWidth = wx.TextCtrl( self. m_panel2, wx.ID_ANY, u"1800", wx.DefaultPosition, wx.Size( 50,-1 ), 0 )
		bSizer16.Add( self.m_textCairoImgWidth, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 1 )
		
		self.m_staticText10 = wx.StaticText( self. m_panel2, wx.ID_ANY, u"Height", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText10.Wrap( -1 )
		bSizer16.Add( self.m_staticText10, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5 )
		
		self.m_textCairoImgHeight = wx.TextCtrl( self. m_panel2, wx.ID_ANY, u"18000", wx.DefaultPosition, wx.Size( 50,-1 ), 0 )
		...
		self.m_staticText20 = wx.StaticText( self. m_panel2, wx.ID_ANY, u"Image Output:", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText20.Wrap( -1 )
		bSizer14.Add( self.m_staticText20, 0, wx.ALL, 1 )
		
		bSizer28 = wx.BoxSizer( wx.HORIZONTAL )
		
		self.m_staticText19 = wx.StaticText( self. m_panel2, wx.ID_ANY, u"Folder:", wx.DefaultPosition, wx.Size( 73,-1 ), wx.ALIGN_RIGHT )
		self.m_staticText19.Wrap( -1 )
		bSizer28.Add( self.m_staticText19, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 2 )
		
		self.m_textCairoImgFolder = wx.DirPickerCtrl( self. m_panel2, wx.ID_ANY, u"D:\\Users\\miken.DESKTOP-4FP24QU\\Dropbox\\Grad School\\Phylogenetics\\work\\new-rdp-tipp\\erin-alignments\\test_images", u"Select a folder", wx.DefaultPosition, wx.DefaultSize, wx.DIRP_DEFAULT_STYLE )
		...
		self.m_staticText211 = wx.StaticText( self. m_panel2, wx.ID_ANY, u"File Name:", wx.DefaultPosition, wx.Size( 75,-1 ), wx.ALIGN_RIGHT )
		self.m_staticText211.Wrap( -1 )
		bSizer29.Add( self.m_staticText211, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 1 )
		
		self.m_textCairoImageFile = wx.TextCtrl( self. m_panel2, wx.ID_ANY, u"test.png", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.m_staticText31 = wx.StaticText( self. m_panel2, wx.ID_ANY, u"Phylogeny Parameters:", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.m_staticText32 = wx.StaticText( self. m_panel2, wx.ID_ANY, u"Line Width", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText32.Wrap( -1 )
		bSizer281.Add( self.m_staticText32, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 1 )
		
		self.m_textPhylogenyLineWidth = wx.TextCtrl( self. m_panel2, wx.ID_ANY, u"1", wx.DefaultPosition, wx.Size( 50,-1 ), 0 )
		bSizer281.Add( self.m_textPhylogenyLineWidth, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 1 )
		
		
		bSizer281.AddSpacer( ( 25, 0), 0, 0, 5 )
		
		self.m_staticText33 = wx.StaticText( self. m_panel2, wx.ID_ANY, u"Line Color:", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText33.Wrap( -1 )
		bSizer281.Add( self.m_staticText33, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 1 )
		
		self.m_colourPhylogeny = wx.ColourPickerCtrl( self. m_panel2, wx.ID_ANY, wx.BLACK, wx.DefaultPosition, wx.DefaultSize, wx.CLRP_DEFAULT_STYLE )
		...
		self.m_staticText222 = wx.StaticText( self. m_panel2, wx.ID_ANY, u"Alignment Parameters", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.m_staticText2111 = wx.StaticText( self. m_panel2, wx.ID_ANY, u"Starting Column", wx.DefaultPosition, wx.Size( -1,-1 ), wx.ALIGN_RIGHT )
		self.m_staticText2111.Wrap( -1 )
		bSizer291.Add( self.m_staticText2111, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 1 )
		
		self.m_textStartColumn = wx.TextCtrl( self. m_panel2, wx.ID_ANY, u"1", wx.DefaultPosition, wx.Size( 50,-1 ), 0 )
		bSizer291.Add( self.m_textStartColumn, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 1 )
		
		
		bSizer291.AddSpacer( ( 10, 0), 0, 0, 5 )
		
		self.m_staticText21111 = wx.StaticText( self. m_panel2, wx.ID_ANY, u"# Columns", wx.DefaultPosition, wx.Size( -1,-1 ), wx.ALIGN_RIGHT )
		self.m_staticText21111.Wrap( -1 )
		bSizer291.Add( self.m_staticText21111, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 1 )
		
		self.m_textNumColumns = wx.TextCtrl( self. m_panel2, wx.ID_ANY, u"200", wx.DefaultPosition, wx.Size( 50,-1 ), 0 )
		...
		self.m_staticText34 = wx.StaticText( self. m_panel2, wx.ID_ANY, u"Margin to Aignment:", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText34.Wrap( -1 )
		bSizer292.Add( self.m_staticText34, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 1 )
		
		self.m_textAlignmentPhylogenySpacerWidth = wx.TextCtrl( self. m_panel2, wx.ID_ANY, u"1", wx.DefaultPosition, wx.Size( 25,-1 ), 0 )
		...
		self.m_staticText28 = wx.StaticText( self. m_panel2, wx.ID_ANY, u"% width for Taxonomy", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText28.Wrap( -1 )
		bSizer24.Add( self.m_staticText28, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5 )
		
		self.m_textPctWidthToPhylogeny = wx.TextCtrl( self. m_panel2, wx.ID_ANY, u"20", wx.DefaultPosition, wx.Size( 50,-1 ), 0 )
		...
		self.m_staticText281 = wx.StaticText( self. m_panel2, wx.ID_ANY, u"% width for Alignment", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText281.Wrap( -1 )
		bSizer241.Add( self.m_staticText281, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5 )
		
		self.m_textPctWidthToAlignment = wx.TextCtrl( self. m_panel2, wx.ID_ANY, u"60", wx.DefaultPosition, wx.Size( 50,-1 ), 0 )
		bSizer241.Add( self.m_textPctWidthToAlignment, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5 )
		
		
		bSizer14.Add( bSizer241, 0, 0, 5 )
		
		self.m_button2 = wx.Button( self. m_panel2, wx.ID_ANY, u"Redraw Cairo Image", wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer14.Add( self.m_button2, 0, wx.ALL|wx.EXPAND, 5 )
		
		self.m_BatchImageButton = wx.Button( self. m_panel2, wx.ID_ANY, u"Make Batch of Images", wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer14.Add( self.m_BatchImageButton, 0, wx.ALL|wx.EXPAND, 5 )
		
		self.m_button7 = wx.Button( self. m_panel2, wx.ID_ANY, u"MyButton", wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer14.Add( self.m_button7, 0, wx.ALL, 5 )
		
		self.m_button8 = wx.Button( self. m_panel2, wx.ID_ANY, u"MyButton", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.m_staticText11 = wx.StaticText( self. m_panel2, wx.ID_ANY, u"Colors:", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText11.Wrap( -1 )
		bSizer18.Add( self.m_staticText11, 0, wx.ALL, 1 )
		
		bSizer19 = wx.BoxSizer( wx.HORIZONTAL )
		
		self.m_staticText13 = wx.StaticText( self. m_panel2, wx.ID_ANY, u"A:", wx.DefaultPosition, wx.Size( 25,-1 ), wx.ALIGN_RIGHT )
		self.m_staticText13.Wrap( -1 )
		bSizer19.Add( self.m_staticText13, 0, wx.ALL, 5 )
		
		self.m_colourA = wx.ColourPickerCtrl( self. m_panel2, wx.ID_ANY, wx.Colour( 0, 127, 255 ), wx.DefaultPosition, wx.DefaultSize, wx.CLRP_DEFAULT_STYLE )
		bSizer19.Add( self.m_colourA, 0, wx.ALL, 1 )
		
		self.m_staticText221 = wx.StaticText( self. m_panel2, wx.ID_ANY, u"alpha:", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText221.Wrap( -1 )
		bSizer19.Add( self.m_staticText221, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 1 )
		
		self.m_alphaA = wx.TextCtrl( self. m_panel2, wx.ID_ANY, u"1.0", wx.DefaultPosition, wx.Size( 50,-1 ), 0 )
		...
		self.m_staticText131 = wx.StaticText( self. m_panel2, wx.ID_ANY, u"C:", wx.DefaultPosition, wx.Size( 25,-1 ), wx.ALIGN_RIGHT )
		self.m_staticText131.Wrap( -1 )
		bSizer191.Add( self.m_staticText131, 0, wx.ALL, 5 )
		
		self.m_colourC = wx.ColourPickerCtrl( self. m_panel2, wx.ID_ANY, wx.Colour( 233, 239, 0 ), wx.DefaultPosition, wx.DefaultSize, wx.CLRP_DEFAULT_STYLE )
		bSizer191.Add( self.m_colourC, 0, wx.ALL, 1 )
		
		self.m_staticText2211 = wx.StaticText( self. m_panel2, wx.ID_ANY, u"alpha:", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText2211.Wrap( -1 )
		bSizer191.Add( self.m_staticText2211, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 1 )
		
		self.m_alphaC = wx.TextCtrl( self. m_panel2, wx.ID_ANY, u"1.0", wx.DefaultPosition, wx.Size( 50,-1 ), 0 )
		...
		self.m_staticText1311 = wx.StaticText( self. m_panel2, wx.ID_ANY, u"G:", wx.DefaultPosition, wx.Size( 25,-1 ), wx.ALIGN_RIGHT )
		self.m_staticText1311.Wrap( -1 )
		bSizer1911.Add( self.m_staticText1311, 0, wx.ALL, 5 )
		
		self.m_colourG = wx.ColourPickerCtrl( self. m_panel2, wx.ID_ANY, wx.Colour( 183, 255, 111 ), wx.DefaultPosition, wx.DefaultSize, wx.CLRP_DEFAULT_STYLE )
		bSizer1911.Add( self.m_colourG, 0, wx.ALL, 1 )
		
		self.m_staticText2212 = wx.StaticText( self. m_panel2, wx.ID_ANY, u"alpha:", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText2212.Wrap( -1 )
		bSizer1911.Add( self.m_staticText2212, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 1 )
		
		self.m_alphaG = wx.TextCtrl( self. m_panel2, wx.ID_ANY, u"1.0", wx.DefaultPosition, wx.Size( 50,-1 ), 0 )
		...
		self.m_staticText1312 = wx.StaticText( self. m_panel2, wx.ID_ANY, u"U/T:", wx.DefaultPosition, wx.Size( 25,-1 ), wx.ALIGN_RIGHT )
		self.m_staticText1312.Wrap( -1 )
		bSizer1912.Add( self.m_staticText1312, 0, wx.ALL, 5 )
		
		self.m_colourT = wx.ColourPickerCtrl( self. m_panel2, wx.ID_ANY, wx.Colour( 255, 74, 74 ), wx.DefaultPosition, wx.DefaultSize, wx.CLRP_DEFAULT_STYLE )
		bSizer1912.Add( self.m_colourT, 0, wx.ALL, 1 )
		
		self.m_staticText2213 = wx.StaticText( self. m_panel2, wx.ID_ANY, u"alpha:", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText2213.Wrap( -1 )
		bSizer1912.Add( self.m_staticText2213, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 1 )
		
		self.m_alphaT = wx.TextCtrl( self. m_panel2, wx.ID_ANY, u"1.0", wx.DefaultPosition, wx.Size( 50,-1 ), 0 )
		...
		self.m_staticText35 = wx.StaticText( self. m_panel2, wx.ID_ANY, u"Image Borders:", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.m_staticText36 = wx.StaticText( self. m_panel2, wx.ID_ANY, u"Top:", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText36.Wrap( -1 )
		bSizer301.Add( self.m_staticText36, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 1 )
		
		self.m_borderTop = wx.TextCtrl( self. m_panel2, wx.ID_ANY, u"2", wx.DefaultPosition, wx.Size( 30,-1 ), 0 )
		bSizer301.Add( self.m_borderTop, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 1 )
		
		self.m_staticText37 = wx.StaticText( self. m_panel2, wx.ID_ANY, u"Bot.", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText37.Wrap( -1 )
		bSizer301.Add( self.m_staticText37, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 1 )
		
		self.m_borderBottom = wx.TextCtrl( self. m_panel2, wx.ID_ANY, u"2", wx.DefaultPosition, wx.Size( 25,-1 ), 0 )
		bSizer301.Add( self.m_borderBottom, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 1 )
		
		self.m_staticText38 = wx.StaticText( self. m_panel2, wx.ID_ANY, u"Left", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText38.Wrap( -1 )
		bSizer301.Add( self.m_staticText38, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 1 )
		
		self.m_borderLeft = wx.TextCtrl( self. m_panel2, wx.ID_ANY, u"2", wx.DefaultPosition, wx.Size( 25,-1 ), 0 )
		bSizer301.Add( self.m_borderLeft, 0, wx.ALL, 1 )
		
		self.m_staticText39 = wx.StaticText( self. m_panel2, wx.ID_ANY, u"Right", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText39.Wrap( -1 )
		bSizer301.Add( self.m_staticText39, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 1 )
		
		self.m_borderRight = wx.TextCtrl( self. m_panel2, wx.ID_ANY, u"2", wx.DefaultPosition, wx.Size( 25,-1 ), 0 )
		...
		bSizer18.Add( self.m_staticline5, 0, wx.EXPAND |wx.ALL, 5 )
		...
		self.m_panel3.SetSizer( bSizer282 )
		self.m_panel3.Layout()
		bSizer282.Fit( self.m_panel3 )
		bSizer18.Add( self.m_panel3, 1, wx.EXPAND |wx.ALL, 0 )
		...
		self.m_notebook2.AddPage( self. m_panel2, u"Controls", True )
		...
		self.m_checkBox1.Bind( wx.EVT_CHECKBOX, self.on_mask_gappy_columns )
		self.m_textCtrl20.Bind( wx.EVT_TEXT_ENTER, self.on_change_gappy_threshold )
		...
		self.m_button7.Bind( wx.EVT_BUTTON, self.prepare_annotation_colorpickers )
		self.m_button8.Bind( wx.EVT_BUTTON, self.populate_annotation_values )
	...
	def on_mask_gappy_columns( self, event ):
		event.Skip()
	
	def on_change_gappy_threshold( self, event ):
		event.Skip()
	...
	def prepare_annotation_colorpickers( self, event ):
		event.Skip()
